...
Discussion of this work occurs on the [Secure Evidence and Attestation Transport
Working Group mailing list](mailto:seat@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/seat),
[subscribe](https://mailman3.ietf.org/mailman3/lists/seat.ietf.org/)).
...
[Working Group documents](https://datatracker.ietf.org/wg/seat/documents/).
